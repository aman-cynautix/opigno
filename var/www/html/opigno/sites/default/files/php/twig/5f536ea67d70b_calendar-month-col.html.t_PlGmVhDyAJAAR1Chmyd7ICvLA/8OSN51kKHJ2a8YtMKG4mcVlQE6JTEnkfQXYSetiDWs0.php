...
class __TwigTemplate_86b5a339f28e28e055d29eb66c2a52f6a24e76b53596652bab36fae946d9bd94 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $tags = ["if" => 26];
        $filters = ["escape" => 14, "date" => 36, "t" => 40];
        $functions = [];
    ...
    <div class=\"inner\">
      <div class=\"date-box\"><span class=\"date-day\">";
        ...
        <span class=\"date-month\">";
            // line 37
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_date_format_filter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["item"] ?? null), "date", [])), "M"), "html", null, true);
            echo "</span>
...
";
    ...
    {
        return new Source("", "profiles/opigno_lms/modules/opigno/opigno_calendar/templates/calendar-month-col.html.twig", "/var/www/html/opigno/profiles/opigno_lms/modules/opigno/opigno_calendar/templates/calendar-month-col.html.twig");
    }
}
